...
var api_module_1 = __webpack_require__(328);
...
Object.defineProperty(exports, "__esModule", { value: true });
var _exports_1 = __webpack_require__(49);
var _defaultCanvasWidth = 500,
    _defaultCanvasHeight = 500;
var API = /** @class */function () {
    function API() {
        this._canvas = new _exports_1.Canvas();
        this._gameObject = new _exports_1.GameObject();
        this._drawUtil = _exports_1.DrawUtil;
    ...
    API.prototype.createWorld = function (id) {
        return new _exports_1.World(id, this._canvas);
    };
    API.prototype.createScene = function () {
        return new _exports_1.Scene();
    };
    return API;
}();
...
var GameObject = /** @class */function () {
    ...
    GameObject.prototype.testColision = function () {};
    return GameObject;
}();
...
var DrawUtil = /** @class */function () {
    function DrawUtil() {}
    DrawUtil.rect = function (ctx, rect) {
        var gameObject = new _exports_1.GameObject();
    ...
    DrawUtil.sprite = function () {
        return new _exports_1.GameObject();
    };
    return DrawUtil;
}();
...
Object.defineProperty(exports, "__esModule", { value: true });
var SceneInterface = /** @class */function () {
...
var World = /** @class */function () {
    ...
    World.prototype.add = function (scene) {
        this.scenes.push(scene);
        return this;
    };
    World.prototype.render = function () {
        this._currentTime = new Date().getTime();
        var elapsed = this._currentTime - this._previousTime;
        if (elapsed > 1000 / 30) {
    ...
    World.prototype.initLoop = function () {
        _exports_1.GameLoop.start(this);
    };
    return World;
}();
exports.World = World;
...
Object.defineProperty(exports, "__esModule", { value: true });
var GameLoopInterface = /** @class */function () {
    function GameLoopInterface() {}
    return GameLoopInterface;
}();
exports.GameLoopInterface = GameLoopInterface;
...
var Gravity = /** @class */function () {
    function Gravity() {
        this._acceleration = 0.10;
    }
    Gravity.prototype.getAcceleration = function () {
        return this._acceleration;
    };
    Gravity.prototype.fall = function () {
...
Object.defineProperty(exports, "__esModule", { value: true });
var GravityInterface = /** @class */function () {
