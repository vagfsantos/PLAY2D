...
Object.defineProperty(exports, "__esModule", { value: true });
var _exports_1 = __webpack_require__(89);
...
var API = /** @class */function () {
    function API() {
        ...
        this.drawUtil = _exports_1.DrawUtil;
    ...
    API.prototype.createDraw = function (type, params) {
        switch (type) {
            case 'rect':
                return this.drawUtil.rect(this.ctx, params);
            case 'arc':
    ...
    API.prototype.createWorld = function (id) {
        return new _exports_1.World(id);
    };
...
var GameObject = /** @class */function () {
    ...
    GameObject.prototype.setUpdate = function (update) {
